...
const SocialLogin = ({ classes }) =>
  <div className={classes.root}>
    <a style={{ display: 'block', flexBasis: '50%' }}
       href={`https://graph.facebook.com/v2.1/oauth/authorize?redirect_uri=${BACKEND_URL}/authenticated/facebook&scope=email&response_type=code&client_id=2175525285996959`}>
